...
import AdoptionChecklist from "./resources/AdoptionChecklist";

export default function MapResources({ hash }) {
  const Content = hash === "#guides/checklist" ? AdoptionChecklist : hash === "#how-pawline-works" ? Methodology : hash === "#guides/nearby" ? NearbyGuide : hash === "#guides/matching" ? MatchingGuide : Guides;
