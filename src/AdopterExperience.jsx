...
export default function AdopterExperience({ pets, saved, onSave, isSignedIn = false, view = "home", active = true, onNavigate, applicationPet, onApplicationHandled, onOpenMap, getToken, feed }) {
