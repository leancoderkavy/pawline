...
function Discovery({ pets, searchLocation, searchDistance, profile, saved, onSave, onOpen, onOpenMap, feed }) {
...
export default function AdopterExperience({ pets, nearbyPets = pets, searchLocation, searchDistance, saved, onSave, isSignedIn = false, view = "home", active = true, onNavigate, applicationPet, onApplicationHandled, onOpenMap, onOpenMessages, onOpenAuth, clerkConfigured, getToken, feed }) {
  ...
  const currentPage = selectedPet
    ...
    : view === "discover" ? <Discovery pets={nearbyPets} searchLocation={searchLocation} searchDistance={searchDistance} feed={feed} profile={profile} saved={saved} onSave={onSave} onOpen={openPet} onOpenMap={onOpenMap} />
