  ...
  return <div className="chat-feature">
    ...
    <div className={`direct-workspace ${selected ? "has-selection" : ""}`}>
      ...
      <section className="direct-thread" aria-label="Private conversation">
        ...
        </> : <div className="direct-empty direct-thread-empty"><PawPrint /><p className="chat-eyebrow">Good questions. Better matches.</p><strong>Get to know them, together.</strong><p>Choose a conversation to ask questions and agree on the next step with the caregiver.</p><button type="button" className="button" onClick={onBrowse}>Explore pets</button></div>}
      </section>
    </div>
