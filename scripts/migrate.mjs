...
if (!dryRun) [verification] = await sql`
  SELECT
    ...
    to_regclass('public.caregiver_registrations') AS caregiver_registrations,
...
const requiredTables = [
  ...
  "organizations", "caregiver_registrations", "organization_locations", "organization_memberships", "organization_claim_tokens",
