...
export default function PrivacyPage() {
  return <main className="methodology-page">
    ...
    <article id="main-content" className="methodology-content legal-content" tabIndex={-1}>
      <p className="methodology-kicker">Effective September 21, 2026</p>
      ...
      <section><h2>Service providers and public sources</h2><p>Pawline relies on providers for hosting, authentication, database storage, maps, realtime messaging, email, product analytics, and narrowly enabled AI features. Pet and shelter information may also come from identified public or authorized sources. Providers process information under their own terms and Pawline's configuration of their services.</p></section>
      <section><h2>Product analytics</h2><p>Pawline uses PostHog to measure activity such as visits, sign-ups, sign-ins, searches, favorites, messages, and applications. After you sign in, those events are linked to your account id. Pawline does not send passwords, message text, or application answers to analytics.</p></section>
