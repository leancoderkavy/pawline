...
export default function PrivacyPage() {
  return <main className="methodology-page">
    ...
    <article id="main-content" className="methodology-content legal-content" tabIndex={-1}>
      ...
      <section><h2>Searches, lost-pet reports, and meetings</h2><p>Saved searches are private to your account and may include location coordinates you choose to save. Lost-and-found reports publish the pet description, city or neighborhood, and date you supply; do not include an exact home address, contact information, or microchip identifier. Tips are visible only to the report owner. Open reports leave public search after 90 days, or when you mark them closed or reunited; this does not automatically delete their stored records or tips. Report flags help hide potentially abusive listings. Meeting proposals and confirmations are shared only with participants authorized for the associated conversation. Video media is not recorded by these meeting tools.</p></section>
