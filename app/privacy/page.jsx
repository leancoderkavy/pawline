...
export default function PrivacyPage() {
  return <main className="methodology-page">
    ...
    <article id="main-content" className="methodology-content legal-content" tabIndex={-1}>
      <p className="methodology-kicker">Effective September 8, 2026</p>
      ...
      <section><h2>Appointments and video hellos</h2><p>Appointment times, notes, confirmation status, and next steps are shared within the pet's private conversation with the adopter and authorized caregiver team. Optional appointment emails are sent through Resend to your verified account email; you can turn them off in the appointment. Calendar downloads contain the meeting time and pet name and are stored wherever you choose to import them.</p><p>When video is available and you choose to join, Daily processes your display name, an opaque participant identifier, connection information, and live audio or video you enable. Pawline does not record or transcribe these calls. Pawline stores appointment history and may receive participant join and leave times from Daily for service reliability. Camera and microphone access are optional browser permissions. See <a href="https://www.daily.co/legal/privacy/">Daily's privacy policy</a> for its handling of service data.</p></section>
